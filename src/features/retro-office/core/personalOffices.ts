...
export const PERSONAL_OFFICE_SLOTS: PersonalOfficeSlot[] = [
  {
    ...
    seat: { x: 1690, y: ROOM_TOPS[0] + 62, facing: Math.PI },
    executive: true,
  },
  {
    key: "office-1",
    ...
    seat: { x: 1690, y: ROOM_TOPS[1] + 62, facing: Math.PI },
    executive: false,
  },
  {
    key: "office-2",
    ...
    seat: { x: 1690, y: ROOM_TOPS[2] + 62, facing: Math.PI },
    executive: false,
  },
  {
    key: "office-3",
    ...
    seat: { x: 1690, y: ROOM_TOPS[3] + 62, facing: Math.PI },
    executive: false,
  },
];
